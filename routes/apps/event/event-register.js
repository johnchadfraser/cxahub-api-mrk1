  ...
  wrap(async function (req, res) {
    ...
    if (checkExist === undefined || checkExist.length == 0) {
      const { rows } = await db.query(
        `INSERT INTO ${tableName} (user_first_name, user_last_name, user_email, user_company, user_ip, u_type_id, ur_id, ut_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
        [
          user_first_name,
          user_last_name,
          user_email,
    ...
    //Create user RSVP.
    await EventService.addEventUserRSVPRel(e_id, id);
